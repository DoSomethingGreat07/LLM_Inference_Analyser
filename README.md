...
- benchmark more local models
- add a prompt-size matrix with short, medium, and long prompts
- add an output-token-size matrix
- add concurrency testing
- add GPU and CPU utilization tracking
- add Prometheus and Grafana monitoring
- add a lightweight FastAPI dashboard
- compare Ollama with vLLM or other serving engines
- generate automated benchmark comparison reports

## LinkedIn note

This project is part of my public learning journey on LLM Infrastructure, where I am building small but practical systems to understand how models move from prompts to production-ready inference.
